...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(html-mode-default ((t (:inherit sgml-mode-default :slant normal :weight normal :height 130 :family "monaco"))) t)
 '(text-mode-default ((t (:inherit autoface-default :strike-through nil :underline nil :slant normal :weight normal :height 130 :width normal :family "monaco"))) t))
